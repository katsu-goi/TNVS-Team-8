...
const routes = [
  { method: "GET", path: "/ai/providers", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getProviders },
  { method: "POST", path: "/ai/providers", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: addProvider },
  { method: "PUT", path: "/ai/providers/:id/default", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: setDefaultProvider },
  { method: "DELETE", path: "/ai/providers/:id", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: deleteProvider },
  { method: "GET", path: "/ai/modules", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getModules },
  { method: "PUT", path: "/ai/modules/:id/toggle", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: toggleModule },
  { method: "PUT", path: "/ai/modules/:id/config", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: updateModuleConfig },
  { method: "GET", path: "/ai/modules/:id/models", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getModuleModels },
  { method: "GET", path: "/ai/prompt", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getSystemPrompt },
  { method: "PUT", path: "/ai/prompt", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: updateSystemPrompt },
  { method: "GET", path: "/ai/logs", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getLogs },
  { method: "GET", path: "/ai/analytics", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getAnalytics },
  { method: "POST", path: "/ai/test-connection", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: testConnection },
  { method: "POST", path: "/ai/models", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: fetchModelsHandler },
  { method: "POST", path: "/ai/classify", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: classifyDocumentHandler },
  { method: "POST", path: "/ai/analyze-contract", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: analyzeContractHandler },
  { method: "POST", path: "/ai/execute", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: executeLiveAi },
  { method: "GET", path: "/ai/instructions", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getModuleInstructions },
  { method: "GET", path: "/ai/instructions/:moduleKey", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getModuleInstruction },
  { method: "PUT", path: "/ai/instructions/:moduleKey", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: updateModuleInstruction },
  { method: "PUT", path: "/ai/instructions/:moduleKey/toggle", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: toggleModuleInstruction },
  { method: "POST", path: "/ai/instructions/:moduleKey/restore/:version", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: restoreModuleInstruction },
  { method: "GET", path: "/ai/modules/detect", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: detectModuleHandler },
  { method: "POST", path: "/ai/context", guard: { kind: "roles", roles: ["SUPER_ADMIN"] }, handler: getModuleDataContext },
