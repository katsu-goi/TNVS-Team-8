...
export const DEFAULT_CORS: CorsOptions = {
  ...
  allowHeaders:
    "Authorization,Content-Type,X-Requested-With,Accept,Origin,User-Agent,Accept-Language",
...
export function corsHeaders(options: CorsOptions = DEFAULT_CORS): Headers {
  ...
  headers.set("Access-Control-Allow-Headers", options.allowHeaders ?? "Authorization,Content-Type");
