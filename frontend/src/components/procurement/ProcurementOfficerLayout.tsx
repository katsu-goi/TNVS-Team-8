...
import {
  ...
  ChevronRight, AlertTriangle, Search, Handshake,
  BellRing, Building2, Gavel,
} from 'lucide-react';
...
export const ProcurementOfficerLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'legal-cases', label: 'Legal Cases', path: '/procurement/legal-cases', icon: Gavel, view: true },
    { id: 'audit', label: 'Audit Trail', path: '/procurement/audit-logs', icon: ScrollText, view: true },
      ...
      <aside className="fixed top-0 left-0 w-72 h-screen z-30 bg-[#042F24] flex flex-col overflow-hidden shadow-2xl">
        <div className="p-5 pb-4 flex items-center space-x-3 shrink-0 bg-[#011E17] border-b border-[#00E676]/20">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-[#00E676] font-medium truncate">Contract Officer</p>
          </div>
        </div>
          ...
          <div className="bg-[#042F24]/80 rounded-xl border border-[#00E676]/15 p-2.5 backdrop-blur-sm">
            <div className="flex items-center justify-between px-3 py-2 rounded-lg">
              <div className="flex items-center space-x-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-semibold text-white truncate leading-tight">{user?.fullName || 'Contract Officer'}</p>
                  <p className="text-[10px] text-white/70 font-mono truncate leading-tight">CONTRACT_OFFICER</p>
                </div>
              </div>
        ...
        <header className="sticky top-0 z-10 bg-white/85 backdrop-blur-md border-b border-slate-200 px-8 py-4 flex items-center justify-between shrink-0">
          <div className="flex items-center space-x-4 flex-1 max-w-md">
            <div className="relative w-full">
              ...
              <input type="text" placeholder="Search contracts, vendors, or documents..."
          ...
          <div className="flex items-center space-x-3">
            <NotificationBell />
            <span className="text-xs text-slate-400 font-mono">Contract &amp; Procurement Management</span>
          </div>
        </header>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-xl w-full max-w-sm p-6 space-y-5">
            <div className="flex items-center space-x-3 text-red-600">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Terminate contract officer session?</p>
              </div>
            </div>
