...
export const ComplianceOfficerLayout: React.FC = () => {
  ...
  const navItems = [
    { id: 'dashboard', label: 'Dashboard', path: '/compliance', icon: LayoutDashboard },
      ...
      <aside className="fixed top-0 left-0 w-72 h-screen z-30 bg-[#D02F34] flex flex-col overflow-hidden shadow-2xl">
        <div className="p-5 pb-4 flex items-center space-x-3 shrink-0 bg-[#A9252A] border-b border-white/10">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-[#FFC629] font-medium truncate">Compliance Officer</p>
          </div>
        </div>
        ...
        <header className="sticky top-0 z-10 bg-white/85 backdrop-blur-md border-b border-slate-200 px-8 py-4 flex items-center justify-between shrink-0">
          <div className="flex items-center space-x-4 flex-1 max-w-md">
            <div className="relative w-full">
              ...
              <input type="text" placeholder="Search documents, contracts, or policies..."
