...
import { Bell, Calendar, Eye, FileText, LayoutDashboard, ScanLine, Settings, User } from 'lucide-react';
...
const navItems: PortalNavItem[] = [
  ...
  { id: 'qr-check-in', label: 'QR Guest Check-in', path: '/facilities-officer/qr-check-in', icon: ScanLine },
